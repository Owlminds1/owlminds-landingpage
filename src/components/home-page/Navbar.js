  ...
  return (
    <nav className="pt-5 pb-2">
      <div className="mx-auto  max-w-7xl px-2 sm:px-6 lg:pl-3 lg:pr-0">
        <div className={`relative flex h-16 items-center justify-between ${isOpen ? 'sm:relative fixed top-0 left-0 right-0 z-[10000] bg-white shadow-md' : ''}`}>
          <div className={`flex w-full items-center justify-between ${isOpen ? 'mx-auto max-w-7xl px-2 sm:px-0' : ''}`}>
            <div className="flex flex-1 items-center justify-start sm:items-stretch sm:justify-between">
              ...
              <div className="hidden sm:ml-0 sm:block sm:my-auto sm:mr-6">
                <Link href="/register">
